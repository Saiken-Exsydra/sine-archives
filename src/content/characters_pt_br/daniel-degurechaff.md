...
registry_status: "Não registrado no Apocachynthion; caso confirmado de fusão divina não-Redactor"
designation: "Quenched Mercy"
height: "183 cm"
build: "Magro, disciplinado e econômico; força contida na quietude antes do movimento"
complexion: "Pálido para os padrões de Ardeatus; traços severos frequentemente confundidos com desaprovação"
hair: "Vermelho escuro, longo e normalmente penteado para trás"
eyes: "Castanho-avermelhados com brilho metálico, ficando mais intensos durante manifestações ativas"
dress: "Uniforme diplomático ardeatano preto e branco com detalhes discretos em latão; revestimento resistente a calor e luvas pretas reforçadas"
residence: "Complexo diplomático de Sarn Pell, Região Sul de Synus"
occupation: "Senior Tempering Witness e principal responsável pela transferência de casos de custódia envolvendo Redactors nascidos em Ardeatus"
...
> - S. Vaerholt, avaliador externo do Apocachynthion, ano 2198

---

## O Que Ele É

Daniel Degurechaff é o eixo humano do Marta Chord: o protocolo de custódia de fronteira pelo qual Redactors nascidos em Ardeatus são removidos dos sistemas punitivos do Covenant e transferidos para classificação imperial em vez de serem executados, enterrados em contenções seladas ou falsamente rotulados como Ashborne. Em registros formais ardeatanos, seu nome aparece como **Daniel ker-Degurechaff**; a partícula é suprimida no uso imperial. A Chord é um procedimento. Daniel é a pessoa que impede esse procedimento de desmoronar sob doutrina, política, exaustão e conveniência institucional.
...
Daniel é um vessel estabilizado há décadas de **Vhaldr, a Tempering Witness**, um fragmento de nível Ardenke do Manifold de Vekrath. Vhaldr não é um fragmento amplo de fogo. Ele não governa chamas de forma genérica. Sua lei é mais estreita e brutal: metal levado à obediência através do calor.

Esse domínio define tudo sobre o poder dele. Daniel não consegue controlar metal frio. Primeiro ele precisa levar o metal ao estado de forja, amolecer, aquecer e só então consegue dobrar, fundir, puxar, travar ou redirecionar aquilo. Por isso, suas manifestações sempre deixam evidências: brilho intenso, ar queimado, estalos de tensão, descoloração, vapor, bordas amolecidas, estruturas deformadas e risco para qualquer ser vivo perto demais do processo.

É isso que o torna aterrorizante em ambientes de custódia. Quase toda sala importante possui contenções, dobradiças, fechaduras, trilhos, rebites, armas, fivelas, suportes ou encaixes estruturais. Na presença de Daniel, qualquer uma dessas coisas pode virar ferramenta, barreira, sentença ou falha estrutural.

Sua manifestação politicamente mais valiosa não é combate, mas o **Witness Heat**: um estado controlado de avaliação no qual ele percebe o que resiste sob pressão. Indexação divina, fome Ashborne, emergências de Redactory, medo, trauma, coerção, relatórios falsos, contenções ocultas e sabotagem institucional se tornam muito mais difíceis de esconder perto dele.
...
Até 2200, a Chord já transferiu milhares de pessoas para custódia imperial. Daniel conhece o nome daqueles que não sobreviveram.

---

## Posição no Registro do Apocachynthion
...
Seu comportamento social é controlado a ponto de causar desconforto. Ele é formal, preciso e econômico nas palavras. Não preenche silêncio a menos que o silêncio tenha se tornado ineficiente. Sua raiva é procedural, não explosiva: nomes, datas, cadeias de custódia, assinaturas, inconsistências e a formulação exata daquilo que alguém achou que conseguiria esconder.

Em privado, ele é mais atento do que gentil. Lembra o nome dos Redactors transferidos, se comeram, se suas famílias foram notificadas e se pediram para escrever para casa. Ele registra tudo isso à mão.
...
Daniel vive em Sarn Pell e se desloca constantemente entre locais de custódia na fronteira, complexos diplomáticos e casas de recepção do Apocachynthion. Continua essencial, sobrecarregado, politicamente exposto e cada vez mais difícil de substituir. Ele vem treinando sucessores, mas a avaliação do dossiê é direta: atualmente ninguém alcança o nível de precisão dele em classificações envolvendo Redactors, Tempered, manifestações traumáticas e casos Ashborne ao mesmo tempo.

Ele não é um reconciliador. Não curou a contradição entre Ardeatus e Synus, entre doutrina e misericórdia, nem entre lei e luto. A importância dele é menor e mais difícil do que isso. Daniel tornou essas contradições processuais o suficiente para que menos pessoas morram dentro delas.

A Marta Chord continua existindo porque Daniel Degurechaff tornou difícil demais violá-la em silêncio.
