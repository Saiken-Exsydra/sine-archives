...
title: "Cal'thas"
type: "Place"
summary: "The armory city. The Empire's primary weapons-manufacturing center, where everything the military-industrial complex produces converges — steel, BrightCrystal components, munitions, and the rail artillery platforms assembled in vast workshops."
tags: ["Places", "Cal'thas", "Southern Region", "Empire", "Military", "Industry", "Weapons", "BrightCrystal", "Long War"]
status: "public"
created: "2026-03-31"
updated: "2026-03-31"
...
> — Industrial survey, Southern Region administrative record
...
A large worker population lives in dense residential blocks built by the state — functional, heated, adequately maintained. The housing is not beautiful. It is not designed to be. It is designed to keep the workforce housed, rested, and within transit distance of the factories, which is what Cal'thas needs from its residential infrastructure.

The culture of Cal'thas is production culture. Status is measured in output. The social hierarchy follows the factory hierarchy. The city's civic life is organized around the industrial calendar — shift rotations, production milestones, and the periodic surges in demand that the frontier's needs impose on the manufacturing schedule.
