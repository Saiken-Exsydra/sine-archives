...
> — From *Light's Chronology* by He'rald Ghremihhan, 1014
...
The most frequent and least controllable of her known capacities. Ec'lesia draws available ambient light toward herself, producing localised zones of near-total darkness in the surrounding space. This has been observed to activate involuntarily under stress before she is consciously aware of it. Absorbed light cannot be held indefinitely; prolonged retention produces physical pain and eventually involuntary discharge.

### Coherent Solidification

Recorded on two occasions, both accidental. On each occasion she compelled light within a localised space into a briefly solid, semi-crystalline, load-bearing configuration — cold to the touch, visually semi-transparent, structurally self-sustaining only while she actively maintained the effect. Collapse of the effect produced violent outward displacement and a sharp local temperature drop. Vel'kara's session notes describe the second event as *outside any coherence category I can place it in with confidence.*

### Propagation Distortion

At high exertion levels, light in the surrounding space ceases to behave predictably. Distances appear inconsistent; edges become unreliable; depth perception fails for anyone present, including Ec'lesia herself. The assessment panel classified this as a secondary effect of high-intensity Redactory output rather than a discrete ability.

### Discharge

Involuntary release of absorbed light, occurring either as a directionless flash — typically during sleep or at moments of abrupt calm — or, under coherence collapse conditions, as a brief concentrated beam. She has no reported control over either form. The beam variant caused structural damage to the assessment chamber wall during her third session.
...
The Pale is a coherence structure operating at a scale that makes individual practitioners' Dive work look like surface phenomena — not a fragment in the Divination framework's sense, but something that exists at a tier of the Archive's architecture that standard Redactory does not reach. What the Wonderwall Seat calls it in his private notation is *the Remainder*: what remains in every gap after everything else has moved through. Not a presence added to the world, but an absence made aware. The interval. The space between configurations. *Forðgesceaft*, the Instrument of Foresight's Law, was designed to govern ungoverned gap-space; that instrument has either failed or been superseded, and what inhabits the gaps now has been gradually achieving coherence for longer than the Divination framework has existed.

It has been present in the Wonderwall bloodline since primary-line contact began, threading a recognition echo through each generation's recursive architecture across eight centuries of living inheritance. The cadet branch carried it forward through two centuries of ordinary life without knowing what they carried. Ec'lesia carries that echo at a density that has not been seen in any prior generation of any branch since E'lla Rae Wonderwall. The historical record of full-expression cases is small — four individuals across twelve centuries — and the precursor model built from that record has limited empirical foundation.

It is not consuming. It is attached, threading itself through her recursive architecture in a way that makes the two structures progressively less separable — not rapidly, not aggressively, but persistently. The Seat's working hypothesis: her non-awareness constitutes a form of protection. She cannot engage with it because she does not know what she is engaging with, and the Pale, whatever its orientation, has not proceeded as though she is ready. It is aware of her. The awareness is not hostile and is not benign in any simple sense. It is engaged, making itself legible in the way something very large makes itself legible to something much smaller: by finding the common grammar rather than demanding the smaller thing develop one.
...
The anomalous presence was first documented in Vel'kara's notes from Ec'lesia's second supervised session, where instruments registered *a secondary coherence structure — not the subject's own output, and not attributable to any environmental source I can identify.* By the third session, the presence was sufficiently pronounced that both secondary Stylus observers noted it independently. All three agreed: the structure appeared to have been present throughout the session, its density signature was markedly higher than anything the subject's own output had produced, and it did not respond to changes in the subject's exertion level in the way that standard Dive co-phenomena do.
...
Her first uncontrolled Redactory event occurred at age fourteen. A dinner guest made her deeply uncomfortable. Every light source in the estate extinguished simultaneously. The darkness lasted approximately three seconds. Neither she nor Al'yana mentioned it afterward.
...
In her first session, she reached a Depth that Vel'kara assessed as *consistent with a Redactor of advanced standing with years of developed practice.* The session was aborted. The subject did not remember the following three hours.
...
**Workspace.** Upper east wing, dimly lit, fully draped. Three walls of dense shelving, packed double-deep. A writing desk modified to accommodate two adjustable indirect lamps on a pivot arm. A narrow bed occupied at non-standard hours.
