...
const english: RedactoryContent = {
  ...
  dive: {
    ...
    title: "The Dive",
    intro: "Descend through the ink. Depth broadens conceptual reach, but never creates information from nothing.",
  ...
  sections: [
    ...
    },
    {
      ...
      capability: "Reach a familiar effect quickly and hold it with less pressure than deeper work requires.",
      depthLabel: "Shallow",
    ...
    },
    {
      ...
      capability: "Reach expressions that shallow practice cannot hold, but only by carrying greater strain and greater risk of losing precision.",
    ...
    },
    {
      ...
      body: "An Abyssal Anchor starts deep. Its possible reach is immense, but its Redactor must cross a dangerous distance before even simple expression becomes usable.",
...
const portuguese: RedactoryContent = {
  ...
  dive: {
    ...
    title: "O Dive",
    intro: "Desca pela tinta. A profundidade amplia o alcance conceitual, mas nunca cria informacao do nada.",
  ...
  sections: [
    ...
    },
    {
      ...
      capability: "Alcancar rapidamente um efeito familiar e sustenta-lo com menos pressao que um trabalho profundo exige.",
      depthLabel: "Raso",
    ...
    },
    {
      ...
      capability: "Alcancar expressoes que a pratica rasa nao sustenta, mas apenas suportando maior pressao e maior risco de perder precisao.",
    ...
    },
    {
      ...
      body: "Uma Anchor Abissal comeca profunda. Seu alcance possivel e imenso, mas seu Redactor precisa cruzar uma distancia perigosa antes mesmo de tornar uma expressao simples utilizavel.",
