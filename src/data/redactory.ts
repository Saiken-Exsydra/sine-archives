...
export const redactoryAssets = {
  ...
  diveDeepAnchor: "/images/redactory/dive-deepening.webp",
...
export type DepthSectionData = {
  ...
  progression?: string[];
  plateLabel: string;
  visualVariant: "surface" | "shallow" | "practical" | "deep-anchor" | "near-strata" | "strata" | "abyssal" | "boundary";
  asset?: string;
};
...
const english: RedactoryContent = {
  ...
  depthLabels: ["Surface", "Shallow Anchor", "Practical Use", "Deep Anchor", "Near-Strata", "Strata", "Abyssal Anchor", "Boundary"],
  dive: {
  ...
  sections: [
    ...
    },
    {
      id: "deep-anchor",
      eyebrow: "Deep Anchor",
      title: "A Foundational Route",
      location: "Lower in the Page's grammar, where the Anchor is broader and less derived than surface-near work.",
      body: "A Deep Anchor is not a shallow route upgraded into power. It is a foundational category of Anchor Depth: wider, heavier, and more difficult to stabilize from the start.",
      capability: "Address broader structures such as Combustion, Heat, or Structural Momentum while carrying greater pressure and collapse risk.",
      depthLabel: "Deep Anchor",
      progression: ["Shallow rank: Ignition", "Deep rank: Combustion or Heat", "Dive Depth: how far this act descends", "Reach: lateral extension from the Anchor"],
      plateLabel: "Future plate: Deep Anchor classification",
      visualVariant: "deep-anchor",
      asset: redactoryAssets.diveDeepAnchor,
    },
    {
      id: "near-strata",
      eyebrow: "Near-Strata",
      ...
      body: "Ignition can approach the root question of Fire. A signal can touch communication itself. Dive Depth moves downward; Reach moves outward from the Anchor. Confusing the two is how ambitious work becomes unstable.",
      capability: "Access expressions that ordinary practice cannot hold, while tracking whether the danger is vertical depth, lateral Reach, or the first signs of Overreach.",
    ...
    },
    {
      ...
      body: "An Abyssal Anchor is a foundational category whose route begins at bedrock. Its possible scope is immense, but its Redactor must cross a dangerous distance before even simple expression becomes usable.",
    ...
    },
    {
      ...
      capability: "No deeper ordinary Dive remains. Shorewalking is not greater Reach; it is holding Shore pressure Page-side through the Anchor, body, perception, and surviving continuity.",
      depthLabel: "Boundary",
...
const portuguese: RedactoryContent = {
  ...
  depthLabels: ["Superficie", "Anchor Rasa", "Uso Pratico", "Anchor Profunda", "Proximo aos Strata", "Strata", "Anchor Abissal", "Limite"],
  dive: {
  ...
  sections: [
    ...
    },
    {
      ...
      title: "Uma Rota Fundacional",
      location: "Mais abaixo na gramatica da Page, onde a Anchor e mais ampla e menos derivada que o trabalho perto da superficie.",
      body: "Uma Anchor Profunda nao e uma rota rasa promovida a poder. Ela e uma categoria fundacional de Anchor Depth: mais ampla, mais pesada e mais dificil de estabilizar desde o inicio.",
      capability: "Tratar estruturas mais amplas como Combustion, Heat ou Structural Momentum enquanto carrega mais pressao e risco de colapso.",
      depthLabel: "Anchor Profunda",
      progression: ["Rank raso: Ignition", "Rank profundo: Combustion ou Heat", "Dive Depth: ate onde o ato desce", "Reach: extensao lateral a partir da Anchor"],
      plateLabel: "Placa futura: classificacao de Anchor Profunda",
      visualVariant: "deep-anchor",
      asset: redactoryAssets.diveDeepAnchor,
    },
    {
      ...
      body: "Ignition pode se aproximar da pergunta-raiz de Fire. Um sinal pode tocar a propria comunicacao. Dive Depth se move para baixo; Reach se move para fora da Anchor. Confundir os dois e como trabalho ambicioso fica instavel.",
      capability: "Acessar expressoes que a pratica comum nao sustenta, acompanhando se o perigo vem da profundidade vertical, do Reach lateral ou dos primeiros sinais de Overreach.",
    ...
    },
    {
      ...
      body: "Uma Anchor Abissal e uma categoria fundacional cuja rota nasce no alicerce. Seu escopo possivel e imenso, mas seu Redactor precisa cruzar uma distancia perigosa antes mesmo de tornar uma expressao simples utilizavel.",
    ...
    },
    {
      ...
      capability: "Nao existe Dive comum mais profundo. Shorewalking nao e Reach maior; e segurar pressao da Shore do lado da Page atraves da Anchor, do corpo, da percepcao e da continuidade sobrevivente.",
      depthLabel: "Limite",
